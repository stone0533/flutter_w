                    ...
                    GestureDetector(
                      ...
                      child: Transform(
                        ...
                        child: Builder(
                          builder: (_) {
                            if (isSelected) {
                              return config._selectedIcon ?? WConfig.instance.radioSelectedIcon;
                            }
                            return config._unselectedIcon ?? WConfig.instance.radioUnselectedIcon;
                          },
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: itemBuilder != null
                            ? itemBuilder(field.context, element.key, element.value, isSelected)
                            : Text(
                                element.value,
                                style: config._style,
